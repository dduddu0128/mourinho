...
<%@ include file= "../template/menu.jspf" %>
    ...
    <div id="container">
    	<div id="content">
   <%
String sql="select * from bbs where num="+bean.getNum();
...
try{
	...
	stmt.executeUpdate("update bbs set visitCnt=visitCnt+1 where num="+bean.getNum());
	stmt.close();
	stmt=conn.createStatement();
    ...
    <div class="board_wrap">
        ...
        <div class="board_view_wrap">
            <div class="board_view">
                <div class="title">
                    <jsp:getProperty property="title" name="bean"/>
                </div>
                <div class="info">
                    <dl>
                        <dt>작성자</dt>
                        <dd><jsp:getProperty property="id" name="bean"/></dd>
                    </dl>
                    <dl>
                        <dt>작성일</dt>
                        <dd><jsp:getProperty property="regdate" name="bean"/></dd>
                    </dl>
                    <dl>
                        <dt>조회수</dt>
                        <dd><jsp:getProperty property="visitCnt" name="bean"/></dd>
                    </dl>
                </div>
                <div class="cont">
